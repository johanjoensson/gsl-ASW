...
{
    if(l_m.l < 0){
        Envelope_Hankel h(lm {0, -l_m.l - 1, l_m.m}, kappa_m);
...
{
    if(l_m.l < 0){
        Envelope_Bessel jp1(lm {0, l_m.l  + 1, l_m.m}, kappa_m), jp2(lm {0, l_m.l + 2, l_m.m}, kappa_m);
...
{
    if(l_m.l < 0){
        Envelope_Neumann np1(lm {0, l_m.l + 1, l_m.m}, kappa_m), np2(lm {0, l_m.l + 2, l_m.m}, kappa_m);
...
double off_atomic_integral(const Envelope_Hankel& H1, const Envelope_Hankel& H2, const double rs)
{
    ...
    if(k1 != k2){
        ...
        Envelope_Hankel Hp1 {lm {0, H1.l_m.l + 1, H1.l_m.m}, H1.kappa_m};
        Envelope_Hankel Hm1 {lm {0, H1.l_m.l - 1, H1.l_m.m}, H1.kappa_m};
...
double atomic_integral(const Envelope_Hankel& H1, const Envelope_Bessel& J2, const double rs)
{
    ...
    if(k1 != k2){
        ...
        Envelope_Hankel Hm1 {lm {0, H1.l_m.l - 1, H1.l_m.m}, k1};
        Envelope_Hankel Hp1 {lm {0, H1.l_m.l - 1, H1.l_m.m}, k1};
        Envelope_Bessel Jm1 {lm {0, J2.l_m.l - 1, J2.l_m.m}, k2};
        Envelope_Bessel Jp1 {lm {0, J2.l_m.l - 1, J2.l_m.m}, k2};
...
double atomic_integral(const Envelope_Bessel& J1, const Envelope_Bessel& J2, const double rs)
{
    ...
    if(k1 != k2){
        ...
        Envelope_Bessel Jm1 {lm {0, J1.l().l - 1, J1.l().m}, k1};
        Envelope_Bessel Jp1 {lm {0, J1.l().l + 1, J1.l().m}, k1};
...
double wronskian(const Envelope_Hankel& f, const Envelope_Hankel& g, const double rs)
{
    ...
    std::cout << "WoopWoop\n";
	const Envelope_Hankel fp1(lm{0, f.l().l + 1, f.l().m}, f.kappa());
	const Envelope_Hankel gp1(lm{0, g.l().l + 1, g.l().m}, g.kappa());
...
double wronskian(const Envelope_Bessel& f, const Envelope_Bessel& g, const double rs)
{
	...
	const Envelope_Hankel fm1(lm{0, f.l().l - 1, f.l().m}, f.kappa());
	const Envelope_Hankel gm1(lm{0, g.l().l - 1, g.l().m}, g.kappa());
